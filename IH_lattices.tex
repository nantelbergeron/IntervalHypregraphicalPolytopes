...
%\end{proof}
\vincent{I have a big problem in this proof... see the comment in the middle...}
\vincent{Maybe we should try to find $x,y,z$ which contradict the semidistributivity. But it seems difficult to define in general...}
...
\vincent{I have a problem here with $\{12, 234, 45, 12345\}$...}
