...
\vincent{corollary: counting}
\vincent{It is always a product of simplices...}
...
In fact, the latter were already considered in the literature under the name \defn{fertilitopes}~\cite{Defant-fertilitopes}.
\end{remark}
