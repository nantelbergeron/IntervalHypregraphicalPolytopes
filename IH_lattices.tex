...
For any $\pi$ be such that $A=\Or_\pi$ and $\pi'=(a,b)\pi$ the orientation $A'=\Or_{\pi'}$ satisfies that for all $I\in \II$ we have $S(I,A')\le S(I,B)$.
For this, consider any $I\in \II$. If $s(I,A)=a$ and $b\in I$ then we must have $S(I,A')=b$. 
We also have $b=S(I,A')\le S(I,B)$ since $S(I,B)>b$ would contradict the maximality of the choice of $b$.
In all other case $S(I,A')=S(I,A)\le S(I,B)$. 
Our result would follow f we can find $\pi_1,\ldots,\pi_m$ such that $\pi=\pi_1<\cdots<p_m=\pi'$ in the weak order. This imply $A<A'$ and $\delta_{A',B}$  strictly smaller than $\delta_{A,B}$ and induction would conclude our proof.

To find $\pi$, let  ${\mathcal I}(a,b) = \{ I\in \II: [a,b]\subseteq I\}$ and ${\mathcal J}_A(a)=\{J\in A : S(J,A)\ne a\in J\}$.

\Nantel{Still struggling!I don't understand the argument of Vincent in the note. What guaranties that flipping $a$ and $b$ gives comparable elements?
